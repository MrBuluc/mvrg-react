  ...
  render() {
    return (
      <div>
        ...
        <h2 className={styles.tokenName}>Activearn</h2>
        ...
        <div className={styles.eventWrapper}>
          ...
          <h3>Event Date:</h3> <p> 11-05-2022</p> <h3>Event Location:</h3>{" "}
          <p>MSKU Medical Faculty</p>
          <h3> Event Description:</h3>
          <p>
            In this presentation, we first introduce our research group and
            touch on digital twin, virtual reality (vr-ar-xr) and medicine
            studies; We also make statements about the future with the topics of
